...
find . | grep -Ev '^.$|^.\/testing$|^.\/\/.+' | xargs -I{} mv -v {} /c/xampp/htdocs/directus/public/extensions/custom/interfaces/ssr-search
# Browse into './user/' directory
cd /c/xampp/htdocs/directus/public/extensions/custom/interfaces/ssr-search
